...
if __name__ == '__main__':
    ...
    for epoch in tqdm(range(decoder_epoches)):
        ...
        valid_loss = model_trainer.enc_dec_predict3(test_loader=valid_loader)
    ...
    output_list, label_list = Utils.encdec_predict_test2(saved_model, test_loader)
